...
public class NioEndpoint extends AbstractEndpoint<NioChannel> {
    ...
    public void bind() throws Exception {
        ...
        // 绑定 IP 地址及端口，将 ServerSocketChannel 设置为非阻塞
    ...
    public void startInternal() throws Exception {
        ...
        /**
         * 关于 Acceptor 与 Poller 的注释
         * Acceptor 接受 socket 线程,获取 SocketChannel 对象后封装在 NioChannel 中，然后将 NioChannel 封装在一个
         * PollerEvent 对象中，并将 PollerEvent 对象押入 events queue 内
         * 这是一个典型的生产者-消费者模式， Acceptor 与 Poller 线程之间通过 queue 通信，Acceptor 是 events queue 的生产者，Poller 是 events queue 的消费者
         */
    }
    ...
    protected boolean setSocketOptions(SocketChannel socket) {
        ...
        try {
            ...
            // 构建 NioChannel 对象 (NioChannel 复用？)
    ...
    protected boolean processSocket(KeyAttachment attachment, SocketStatus status, boolean dispatch) {
        try {
            ...
            // 根据选择的 SelecttionKey 构造 SocketProcessor 提交到请求处理线程
